...
export default class LawyerServices {
  static validate(taxNumber, callback, next) {
    const uri = 'https://www.pjud.cl/busqueda-de-abogados'
      ...
      .then((response) => {
        ...
        request(formOptions)
          .then((formResponse) => {
            ...
            console.log('formResponse.statusCode', formResponse.statusCode);
            console.log('formResponse.body', formResponse.body);
